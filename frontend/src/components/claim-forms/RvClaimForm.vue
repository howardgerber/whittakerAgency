<template>
  <div class="rv-claim-form">
    <h3>RV Insurance Claim Details</h3>
    ...
    <div class="form-group">
      ...
      <select id="incident-type" v-model="formData.incident_type" required class="form-control">
        ...
        <option value="appliance_failure">Appliance Failure</option>
    ...
    <div class="form-group">
      <label>RV in Motion When Incident Occurred? *</label>
      <div class="radio-group">
        <label class="radio-label"><input type="radio" v-model="formData.rv_in_motion" value="yes" /> Yes</label>
        <label class="radio-label"><input type="radio" v-model="formData.rv_in_motion" value="no" /> No</label>
      </div>
    </div>
    ...
    <div class="form-group">
      <label>Is the RV Drivable? *</label>
      <div class="radio-group">
        <label class="radio-label"><input type="radio" v-model="formData.rv_drivable" value="yes" /> Yes</label>
        <label class="radio-label"><input type="radio" v-model="formData.rv_drivable" value="no" /> No</label>
      </div>
    </div>

    <div class="form-group">
      <label>Living Quarters Affected? *</label>
      <div class="radio-group">
        <label class="radio-label"><input type="radio" v-model="formData.living_quarters_affected" value="yes" /> Yes</label>
        <label class="radio-label"><input type="radio" v-model="formData.living_quarters_affected" value="no" /> No</label>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea
        ...
        placeholder="Describe the damage to your RV"
...
interface RvClaimFormData {
  ...
  rv_drivable: string
  living_quarters_affected: string
  damage_description: string
}

const emit = defineEmits<{
  (e: 'update', data: RvClaimFormData): void
  (e: 'valid', isValid: boolean): void
}>()

const formData = reactive<RvClaimFormData>({
  incident_type: '',
  incident_location: '',
  rv_in_motion: '',
...
const handlePhoneInput = (event: Event, fieldName: string) => {
  ...
  formData[fieldName as keyof RvClaimFormData] = formatPhoneNumber(input.value) as any
}
...
const isFormValid = computed(() => {
  const baseValid = (
    ...
    formData.rv_in_motion !== '' &&
    formData.other_party_involved !== '' &&
    formData.police_report_filed !== '' &&
    formData.rv_drivable !== '' &&
    formData.living_quarters_affected !== '' &&
