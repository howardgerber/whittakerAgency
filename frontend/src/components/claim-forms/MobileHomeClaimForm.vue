<template>
  <div class="mobile-home-claim-form">
    <h3>Mobile Home Insurance Claim Details</h3>
    ...
    <div class="form-group">
      ...
      <div class="checkbox-group">
        ...
        <label class="checkbox-label"><input type="checkbox" v-model="formData.area_affected" value="exterior" /> Exterior</label>
        <label class="checkbox-label"><input type="checkbox" v-model="formData.area_affected" value="interior" /> Interior</label>
        <label class="checkbox-label"><input type="checkbox" v-model="formData.area_affected" value="skirting" /> Skirting</label>
        <label class="checkbox-label"><input type="checkbox" v-model="formData.area_affected" value="deck_steps" /> Deck/Steps</label>
        <label class="checkbox-label"><input type="checkbox" v-model="formData.area_affected" value="shed" /> Shed</label>
    ...
    <div class="form-group">
      <label>Mobile Home Movable? *</label>
      <div class="radio-group">
        <label class="radio-label"><input type="radio" v-model="formData.mobile_home_movable" value="yes" /> Yes</label>
        <label class="radio-label"><input type="radio" v-model="formData.mobile_home_movable" value="no" /> No</label>
      </div>
    </div>

    <div class="form-group">
      <label>Currently Living in Mobile Home? *</label>
      <div class="radio-group">
        <label class="radio-label"><input type="radio" v-model="formData.currently_living_in_mobile_home" value="yes" /> Yes</label>
        <label class="radio-label"><input type="radio" v-model="formData.currently_living_in_mobile_home" value="no" /> No</label>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea
        ...
        placeholder="Describe the damage to your mobile home"
...
interface MobileHomeClaimFormData {
  incident_type: string
  area_affected: string[]
  damage_extent: string
  mobile_home_movable: string
  currently_living_in_mobile_home: string
  damage_description: string
}

const emit = defineEmits<{
  (e: 'update', data: MobileHomeClaimFormData): void
  (e: 'valid', isValid: boolean): void
}>()

const formData = reactive<MobileHomeClaimFormData>({
  incident_type: '',
  area_affected: [],
  damage_extent: '',
  mobile_home_movable: '',
  currently_living_in_mobile_home: '',
  damage_description: ''
})
...
const isFormValid = computed(() => {
  return (
    ...
    formData.mobile_home_movable !== '' &&
    formData.currently_living_in_mobile_home !== '' &&
...
<style scoped>
.mobile-home-claim-form { width: 100%; }
